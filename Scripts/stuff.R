...
approval %>% slice()
approval %>% slice(2040)
approval <- approval %>% slice(2040)
View(approval.raw)
approval <- approval.raw %>% slice(2040)
dim(approval)
661*3
approval <- approval.raw %>% slice(1983)
dim(approval)
approval <- approval.raw %>% slice(2040)
dim(approval)
661*3
...
approval <- approval %>% filter(approval[1957])
approval <- approval %>% filter(approval[,1957])
approval <- approval %>% filter(approval[1957,])
approval <- approval %>% slice(approval[1957])
approval <- approval %>% slice(1957)
approval <- approval %>% slice(1956)
...
date <- unite(date, "day", sep=" ", c(3))
date$day <- format(as.Date(date$day, "%d %b %Y"), "%Y-%m-%d")
date <- unite(date, "date", sep=" ", c(2))
library(tidyverse)
date <- str_split(date, " ", simplify = TRUE)
date <- date[,c(3,2,6,4,1,5)]
date <- date[, -c(6)]
...
View(tweets)
test <- merge(tweetcount, dates, by="date")
View(test)
test <- merge(tweetcount, dates, by="date", all=TRUE)
test2 <- unique(test)
View(test2)
test <- merge(tweetcount, dates, by="date", type="right")
...
nov3 <- data.frame("date" = as.Date(2018-11-03, format="%Y-%m-%d"), "approve" = 42.15896, "disapprove" = 52.83494)
nov3 <- data.frame("date" = as.Date("2018-11-03"), "approve" = 42.15896, "disapprove" = 52.83494)
nov3
...
g <- ggplot(tweets, aes(x=response)) + geom_density()
g
sum(tweets$response >= 250000)
sum(tweets$response >= 200000)
sum(tweets$response >= 100000)
summary <- summary(tweets)
summary
summary
sum(tweets$response >= 100000)
sum(tweets$response >= 150000)
603/4449
sum(tweets$response >= 175000)
298/4449
...
loadhistory("~/Desktop/Duke/Fall 2018/Modeling/R-Stat/R-Stat.Rproj")
loadhistory("~/Desktop/Duke/Fall 2018/Modeling/R-Stat/other/Untitled.Rhistory")
loadhistory("~/Desktop/Duke/Fall 2018/Modeling/R-Stat/other/Untitled.Rhistory")
tweets <- read.csv("Final Project/Data/tweets.csv")
View(tweets)
tweets <- select(text, created_at, retweet_count, favorite_count)
...
library("RCurl", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
library("shiny", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
library("SnowballC", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
library("stopwords", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
library("text2vec", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
library("textshape", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
...
library("tokenizers", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
